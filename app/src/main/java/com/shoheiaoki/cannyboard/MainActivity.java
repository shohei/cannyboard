...
package com.shoheiaoki.cannyboard;
...
//        checkGLError("onReadyToDraw");
    ...
    public void onDrawEye(EyeTransform transform) {
        ...
        if (convertedBmp != null) {
            ...
            GLUtils.texImage2D(GLES20.GL_TEXTURE_2D, 0, convertedBmp, 0);
...
//        Core.flip(mGry90, mGray90, 1);
        ...
        camera.addCallbackBuffer(mOutputBytes);
//        Log.e("debug","onPreviewFrame() fired");
        convertedBmp = Bitmap.createBitmap(mOutputFrame.cols(), mOutputFrame.rows(), Bitmap.Config.ARGB_8888);
        Utils.matToBitmap(mOutputFrame, convertedBmp);
